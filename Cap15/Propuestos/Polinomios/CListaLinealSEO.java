...
//
public abstract class CListaLinealSEO<T>
{
  ...
  public boolean buscar(T obj)
  {
    ...
    return r == 0; // devuelve: true = encontrado, o
                   // false = no encontrado
  }
  ...
  public T borrar(T obj)
  {
    ...
    if (buscar(obj)) return null; // no está
    // Dos casos:
  ...
  {
    // Devolver una referencia a los datos del elemento actual.
    // Si la lista está vacía, devolver null.
    if ( listaVacía() || elemActual == null ) return null;
