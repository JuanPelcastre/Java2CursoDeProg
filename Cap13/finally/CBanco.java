...
//
public class CBanco implements Cloneable
{
  // Matriz de objetos
  ...
  public CBanco(final CBanco banco) // constructor copia
  {
    cuentas = (ArrayList<CCuenta>)banco.cuentas.clone();
    for (int i = 0; i < cuentas.size(); ++i)
    {
      CCuenta obj = cuentas.get(i);
      cuentas.set(i, obj.clone());
    }
  }
  
  public CBanco clone()
  {
    return new CBanco(this);
  }
